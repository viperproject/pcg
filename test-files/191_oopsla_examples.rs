...
fn dec_max(mut pos: Pos2D<i32>, mut z: i32) {
    ...
    let max3 = if z > *max2 {
        // PCG: bb4[1] pre_operands: Remove Edge borrow: max2 = &mut  pos.x under conditions bb0 -> bb1, bb3 -> bb4
        // PCG: bb4[1] pre_operands: Remove Edge borrow: max2 = &mut  (*_7) before bb2[5]:PreMain under conditions bb0 -> bb2, bb3 -> bb4
        // PCG: bb4[2] pre_main: Expand(RepackExpand { from: _1, guide: None, capability: E })
